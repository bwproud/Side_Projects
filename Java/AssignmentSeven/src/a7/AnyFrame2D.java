...
abstract public class AnyFrame2D implements Frame2D {
	...
	abstract public Frame2D lighten(double factor);
	abstract public Frame2D darken(double factor);
	...
	abstract public Frame2D brightness(double factor);
	abstract public Frame2D saturation(double factor);
